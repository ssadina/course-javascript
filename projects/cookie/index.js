...
addButton.addEventListener('click', () => {
  ...
  // const row = homeworkContainer.querySelector('.row');
  // row.insertAdjacentHTML('afterbegin',`<tr class="row"><th>${addNameInput.value}</th><th>${addValueInput.value}</th><th><button class="remove">Удалить</button></th></tr>`);
